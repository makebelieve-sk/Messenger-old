...
// Добавить крестик для удаления фотографии при наведении на свою аватарку (удалить из бд, с диска и в состоянии) - модалка (вы точно хотите удалить свою аватарку?)
